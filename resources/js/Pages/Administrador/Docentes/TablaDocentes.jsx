// resources/js/Pages/Administrador/Docentes/TablaDocentes.jsx
                            ...
                            <tr key={docente.id}>
                                ...
                                <td className="border px-4 py-2">
                                    <button onClick={() => onEdit(docente)} className="mr-2">
                                        <img src="/images/editar.png" alt="Editar" className="h-5 w-5" />
                                    </button>
                                    <button onClick={() => handleShowModal(docente)}>
                                        <img src="/images/ojo.png" alt="Ver más" className="h-5 w-5" />
                                    </button>
                                </td>
                            </tr>
                        ))
